...
[evidence/task-2026-09-15/README.md](../evidence/task-2026-09-15/README.md). Three successors and U3 are inspected with text
hashes; both derived JSON artifacts were regenerated by their scripts. The prior-art conclusion is written in the two allowed
forms only. Patent search remains open; URC-S08 remains the owner gate.
