...
Generated from [register.json](register.json); edit the register, not this file. Access is stated for every
entry: **read** means the full text was inspected during the prior-art packet and its findings live in
`docs/day3-reading-records.json`; **not read** means the identifier is verified but the text has not been
inspected, so nothing here claims anything about its contents. "Why it is on the list" is a reason for
...
NDSS, 2021 · `doi:10.14722/ndss.2021.24096` · **read** · repository record: `U2`  
...
USENIX Security, 2019 · `https://www.usenix.org/conference/usenixsecurity19/presentation/kim` · not read  
...
Proceedings of the 44th International Conference on Software Engineering, 2022 · `doi:10.1145/3510003.3510084` · not read · repository record: `cited by S1 and S2`  
...
IEEE S&P, 2022 · `doi:10.1109/sp46214.2022.9833567` · **read** · repository record: `S3`  
...
USENIX Security, 2023 · `https://www.usenix.org/conference/usenixsecurity23/presentation/kim-hyungsub` · not read  
...
USENIX Security, to confirm, 2020 · `no verified identifier` · **identifier unresolved**  
...
Proceedings 2022 Network and Distributed System Security Symposium, 2022 · `doi:10.14722/ndss.2022.24244` · not read  
...
Proceedings of the 2020 ACM SIGSAC Conference on Computer and Communications Security, 2020 · `doi:10.1145/3372297.3417249` · not read  
...
Proceedings of the 30th ACM Joint European Software Engineering Conference and Symposium on the Foundations of Software Engineering, 2022 · `doi:10.1145/3540250.3549164` · not read  
...
IEEE Access, 2020 · `doi:10.1109/access.2020.3023250` · not read  
...
ACM Computing Surveys, 2022 · `doi:10.1145/3538644` · not read  
...
ISSTA, 2025 · `doi:10.1145/3728904` · **read** · repository record: `U4`  
...
NDSS, 2026 · `doi:10.14722/ndss.2026.231014` · **read** · repository record: `S2`  
...
FUZZING Workshop, 2026 · `doi:10.14722/fuzzing.2026.23009` · **read** · repository record: `S1`  
...
Software Testing, Verification and Reliability, 2001 · `doi:10.1002/stvr.228` · not read  
...
arXiv, 2021 · `arxiv:2106.14959` · **read** · repository record: `U1`  
...
arXiv, 2019 · `arxiv:1906.11488` · not read  
...
Lecture Notes in Computer Science, 2011 · `doi:10.1007/978-3-642-23881-9_1` · not read  
...
Lecture Notes in Computer Science, 2021 · `doi:10.1007/978-3-030-85248-1_10` · not read  
...
thesis, 2023 · `doi:10.70675/00ae7f23z6964z4102zb62ez392357a8ed33` · not read · repository record: `C-record in the prior-art intake`  
...
2020 International Conference on Communications, Signal Processing, and their Applications (ICCSPA), 2021 · `doi:10.1109/iccspa49915.2021.9385754` · not read  
...
2015 Brazilian Symposium on Computing Systems Engineering (SBESC), 2015 · `doi:10.1109/sbesc.2015.24` · not read  
...
preprint, 2023 · `doi:10.21203/rs.3.rs-3668418/v1` · not read · repository record: `C266 in the prior-art intake`  
...
Theoretical Computer Science, 1994 · `doi:10.1016/0304-3975(94)90010-8` · not read  
...
BRICS Report Series, 1996 · `doi:10.7146/brics.v3i58.18769` · not read  
...
Software: Practice and Experience, 2024 · `doi:10.1002/spe.3372` · not read  
...
Journal of Computer and System Sciences, 1998 · `doi:10.1006/jcss.1998.1581` · not read  
...
Handbook of Networked and Embedded Control Systems, 2005 · `doi:10.1007/0-8176-4404-0_21` · not read  
...
Electronic Proceedings in Theoretical Computer Science, 2012 · `doi:10.4204/eptcs.85.1` · not read  
...
Electronic Proceedings in Theoretical Computer Science, 2022 · `doi:10.4204/eptcs.355.4` · not read  
...
IEEE Access, 2022 · `doi:10.1109/access.2022.3223359` · not read  
...
**L32. Simplicity and complexity in cell cycle control**  
venue unrecorded, year unrecorded · `doi:10.70675/fd34825eza23fz4a6az9dc2zeed4a5eb5536` · not read  
...
IEEE Control Systems, 1998 · `doi:10.1109/37.710880` · not read  
...
2016 IEEE/AIAA 35th Digital Avionics Systems Conference (DASC), 2016 · `doi:10.1109/dasc.2016.7778100` · not read  
...
2020 AIAA/IEEE 39th Digital Avionics Systems Conference (DASC), 2020 · `doi:10.1109/dasc50938.2020.9256425` · not read  
...
2018 IEEE Aerospace Conference, 2018 · `doi:10.1109/aero.2018.8396622` · not read  
...
International Journal on Software Tools for Technology Transfer, 2023 · `doi:10.1007/s10009-023-00712-3` · not read  
...
Journal of Systems Architecture, 2024 · `doi:10.1016/j.sysarc.2023.103036` · not read  
...
arXiv, 2026 · `arxiv:2608.20906` · **read** · repository record: `U11`  
...
venue unrecorded, 2026 · `doi:10.21203/rs.3.rs-9739059/v1` · not read  
...
AIAA Scitech 2019 Forum, 2019 · `doi:10.2514/6.2019-1961` · not read  
...
Aerospace Science and Technology, 2019 · `doi:10.1016/j.ast.2019.105528` · not read · repository record: `prior-art intake row 227`  
...
**L43. Plan-and-Avoid: conflict-aware contingency landing planning**  
arXiv, 2026 · `arxiv:2608.06648` · **read** · repository record: `U10`  
...
JARUS, 2024 · `JARUS SORA v2.5 Main Body (JAR_doc_25)` · **read** · repository record: `baseline B7`  
...
Computer Networks, 2000 · `doi:10.1016/s1389-1286(00)00007-4` · not read  
...
Reliability Engineering &amp; System Safety, 2002 · `doi:10.1016/s0951-8320(01)00092-8` · not read  
...
Lecture Notes in Computer Science, year unrecorded · `doi:10.1007/978-3-540-78743-3_2` · not read  
...
Requirements Engineering, 2009 · `doi:10.1007/s00766-009-0083-y` · not read  
...
Requirements Engineering, 2003 · `doi:10.1007/s00766-002-0157-6` · not read  
...
SICS Software-Intensive Cyber-Physical Systems, 2021 · `doi:10.1007/s00450-021-00428-2` · not read  
...
Advances in Intelligent Systems and Computing, 2016 · `doi:10.1007/978-3-319-41682-3_74` · not read  
...
## Sim Fidelity — Simulation fidelity, software-in-the-loop validity and the simulation-to-reality gap

2 entries.

**L52. An Empirical Analysis of the Use of Real-Time Reachability for the Safety Assurance of Autonomous Vehicles**  
venue unrecorded, 2023 · `doi:10.2139/ssrn.4346428` · not read  
...
Journal of KIISE, 2024 · `doi:10.5626/jok.2024.51.6.528` · not read  
...
arXiv, 2019 · `arxiv:1911.00608` · not read  
...
arXiv, 2020 · `arxiv:2012.10153` · not read  
